      ...
      <div className={styles.container}>
          ...
          <div className={`${styles.title2} row justify-content-center`}>
            ...
            <div className="col-12 col-md-4 col-lg-3 mb-5 mb-md-0 d-flex justify-content-center">
              <a className={styles.product2} href="/album">
                <Image className={styles.pic2} src="/album1.png" width={80} height={113}/>
						  </a>
            </div>
        ...
        <div className={styles.content2}>
          ...
          <div className="row d-flex justify-content-center">
            ...
            <div id="4" className={`${styles.product4} col-12 col-md-4 col-lg-3 mb-5 mb-md-0`}>
              <Link href="/ProductDetail?id=4">
                  <Image className={styles.album4} src="/TXT.png" width={221} height={177} alt="icon" />
              </Link>
              <p className={styles.productname}>TXT (TOMORROW X TOGETHER) - The Name Chapter: FREEFALL (Gravity ver.)</p>
              <p className={styles.productprice}>฿ 383.61</p>
            </div>

            <div id="5" className={`${styles.product5} col-12 col-md-4 col-lg-3 mb-5 mb-md-0`}>
              <Link href="/ProductDetail?id=5">
                  <Image className={styles.album5} src="/SK.png" width={221} height={177} alt="icon" />
              </Link>
              <p className={styles.productname}>Stray Kids - 5-STAR The 3rd Album [Standard Edition]</p>
              <p className={styles.productprice}>฿ 583.51</p>
            </div>
